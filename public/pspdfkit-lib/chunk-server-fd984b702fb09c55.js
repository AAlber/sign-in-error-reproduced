  ...
  [6377],
  {
    16288: (t, e, n) => {
      ...
      var w = n(53678),
        ...
        P = n(92466),
        S = n(13997);
      const _ = "The image can not be rendered because of an unknown error.";
      class b {
        constructor(t) {
          let {
            identifier: e,
            ...
            token: o,
            payload: s,
            doNotRequestWebP: a = !1,
          } = t;
          (this.identifier = e),
            (this.url = n),
            (this.token = o),
            (this.payload = s),
            (this.doNotRequestWebP = a);
        }
        abort() {
          var t;
                  ...
                  return (
                    (o.onload = (n) => {
                      ...
                      s.attachments_not_found
                        ? t({ attachmentsNotFound: s.attachments_not_found })
                        : s.error
                    ...
                    (o.onerror = () => e(new r.p2(_))),
                    void o.readAsText(n.response)
                  );
                }
                if (!(0, w.vu)(n.status)) return void e(new r.p2(_));
                const o = n.response,
                  s = URL.createObjectURL(o),
                  a = new Image();
                (a.onerror = () => e(new r.p2(_))),
                  (a.src = s),
                  await a.decode(),
                  t(new P.Z(a, () => URL.revokeObjectURL(s)));
              }).bind(this)),
              n.send(this.payload);
          });
        }
      ...
      class K extends D.W {
        constructor(t) {
          ...
          if (
            ...
            (0, s.Z)(this, "_requestRenderAnnotation", (t, n, o, s, a, c) => {
              ...
              return (
                (function n() {
                  ...
                  const u = new b({
                      ...
                      payload: c,
                      doNotRequestWebP: s > v.pt || a > v.pt,
                    }),
            ...
            (0, s.Z)(this, "_requestRenderAnnotations", (t, e, n, o, s) => {
              const a = `${this._state.documentURL}/render_annotations`,
                r = JSON.stringify({
                  annotations: e.map((e, s) => ({
                    pageIndex: t,
                    pdfObjectId: e,
                    width: n[s],
                    height: o[s],
          ...
          let c = null,
            ...
            d = null;
          if (a)
            (d = t.hostedBaseUrl || "https://api.pspdfkit.com/"),
              (0, w.sf)(d),
              (0, h.eU)(a);
          else {
            if (
              ((c = (function (t) {
                let e =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : window;
                const n = t.serverUrl || (0, S.SV)(e.document);
                if ("/" !== n.substr(-1))
                  throw new r.p2(
        ...
        async load() {
          ...
          if (
            ...
            this._state.instantSettings && !s.includes(I.q.INSTANT))
          )
            throw new r.p2(
              "Instant feature is not enabled on this server. Please set `instant` to `false`.\n\nFor more information about PSPDFKit Instant please visit:\nhttps://pspdfkit.com/guides/web/current/instant/overview/",
            );
          const y =
            i === f.H.ELECTRONIC_SIGNATURES &&
            (0, L.Vz)(s) &&
          ...
          if (
            ((this._state = this._state.withMutations((t) =>
              t
                ...
                .set(
                  "documentURL",
                  `${this._state.serverUrl}i/d/${this._state.documentId}/h/${d}`,
                )
              ...
              e = this._state.authPayload.accessToken,
              {
                ...
                const n = await fetch(`${t}i/documents/auth`, {
                  ...
                  headers: {
                    ...
                    "PSPDFKit-Platform": "web",
                    "PSPDFKit-Version":
                      "cloud-protocol=1, server-protocol=5, client=2023.5.4, client-git=190df7712c",
                  },
        ...
        async _initProvider() {
          ...
          }
          {
            const t =
                ...
                this._state.features.includes(I.q.FORMS),
                ...
                t.append(
                  ...
                  JSON.stringify({
                    annotations: a.annotations
                      ...
                      .toJS()
                      .map((t) => ({ content: t })),
                    formFieldValues: a.formFieldValues.map(u.kr).toJS(),
                    formFields: a.formFields.map(u.vD).toJS(),
                    signatures: a.signatures || [],
                  }),
                ),
                  n.length > 0 &&
                    n.forEach((e) => {
                      const n = a.attachments.get(e);
                      (0, r.kG)(
                        n && n.data,
        ...
        async renderPageAnnotations(t, e, n) {
                ...
                if (o) {
                  ...
                  t &&
                    ((this.annotationAPStreamPromises =
                      this.annotationAPStreamPromises.delete(o.id)),
                    t(n)),
          ...
          return (
            (this.pageAPStreamsPromises = this.pageAPStreamsPromises.set(t, i)),
            i
          );
        }
          ...
          let s =
            ...
            a =
              arguments.length > 5 && void 0 !== arguments[5]
                ...
                : A.S.TEXT;
          const r = `q=${
              a === A.S.PRESET ? t.replace(/_/g, "-") : encodeURIComponent(t)
        ...
        async searchAndRedact(t, e) {
          const {
              searchType: n,
              annotationPreset: s,
              searchInAnnotations: r,
              caseSensitive: i,
            } = e,
            { color: c, fillColor: l, outlineColor: d } = s,
            u = (0, o.Z)(s, B),
            h = await this._fetch(`${this._state.documentURL}/redactions`, {
              ...
              body: JSON.stringify({
                strategy: n,
                strategyOptions: {
                  [n]: n === A.S.PRESET ? t.replace(/_/g, "-") : t,
          ...
          return (0, a.aV)(
            m && m.annotations
              ? m.annotations.map((t) => O.Z.fromJSON(t.id, t.content))
              : [],
          );
        }
        exportPDF() {
          let {
            ...
            ? arguments[0]
            : {};
          const a = `${this._state.documentURL}/pdf?token=${
            this._state.token
          ...
          if (o) {
            ...
            const { conformance: n, vectorization: s, rasterization: r } = e;
            return fetch(a, {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
          ...
          return fetch(a, { method: "GET", credentials: "include" }).then((t) =>
            t.arrayBuffer(),
          );
        }
        exportXFDF() {
        ...
        exportInstantJSON(t) {
          return this._fetch(
            `${this._state.documentURL}/instant.json${
              "number" == typeof t ? `?version=${t}` : ""
            }`,
          ).then((t) => t.json());
        }
        getPDFURL() {
          ...
          return {
            promise: Promise.resolve(
              `${this._state.documentURL}/pdf?token=${
                this._state.token
              }&flatten=true&comments=${String(t)}&remove_annotations=${String(
                e,
              )}`,
            ),
            revoke: () => {},
        ...
        async setSecondaryMeasurementUnit(t) {
          try {
            const e = JSON.stringify({
              unitTo: t ? t.unitTo : null,
              precision: t ? t.precision : null,
            });
            await this._fetch(
              `${this._state.documentURL}/secondary_measurement_unit`,
              {
        ...
        async applyRedactionsAndReload() {
          try {
            ...
            throw (
              (this.provider.load(),
              new r.p2(`Applying redactions failed: ${t}`))
            );
          }
        }
        ...
        async signDocumentAndReload(t, e) {
          ...
          try {
                      ...
                      J(
                        J(
                          J(
                            ...
                            "position" in t
                              ? { position: (0, u.eE)(t.position) }
                              : null,
                          ),
                          "appearance" in t
                            ? { appearance: (0, u.sr)(t.appearance) }
                            : null,
                        ),
                        "formFieldName" in t
                          ? { formFieldName: t.formFieldName }
                          : null,
                      ),
                      void 0 !== (null == t ? void 0 : t.signingData) &&
                        "signatureContainer" in t.signingData
                        ? {
                            signatureContainer:
                              t.signingData.signatureContainer,
                          }
                        : null,
                    ),
                    void 0 !== (null == t ? void 0 : t.signingData) &&
                      "signatureType" in t.signingData
                      ? { signatureType: u.YA[t.signingData.signatureType] }
                      : null,
                  )
                : null,
              s =
                (null == t || null === (n = t.appearance) || void 0 === n
                  ? void 0
                  : n.watermarkImage) || null,
              a = J(J({}, e ? { signingToken: e.signingToken } : null), o),
              i = new FormData();
            if (
              (i.append("data", JSON.stringify(a)),
              s && i.append("image", s),
              this._destroyProvider(),
            ...
            throw (
              (this.provider.load(),
              new r.p2(`Adding digital signature failed: ${t.message || t}`))
            );
          }
        }
        async setFontSubstitutions(t) {
          try {
            const e = `${this._state.documentURL}/font-substitutions`;
            await this._fetch(e, {
              method: "put",
              body: JSON.stringify({ fontSubstitutions: t }),
              credentials: "include",
              headers: { "Content-Type": "application/json" },
            });
          } catch (t) {
            throw new r.p2(`Error setting font substitution: ${t.message}`);
          }
        }
        getDocumentHandle() {
        ...
        async getEmbeddedFiles() {
          ...
          return (0, a.aV)(
            null != n &&
              null !== (t = n.data) &&
              void 0 !== t &&
              null !== (t = t.embeddedFiles) &&
              void 0 !== t &&
              t.length
              ? n.data.embeddedFiles.map((t) => {
          ...
          o = await Promise.all(
            t.map(async (t, o) => {
              ...
              if ("applyXfdf" === t.type) {
                ...
                const a = new Blob([s], { type: "application/vnd.adobe.xfdf" });
                return (0, T.M)(n, e, a, t, o, "dataFilePath");
              }
              return t;
            }),
          ),
          s = new FormData();
        s.append("operations", JSON.stringify({ operations: o }));
        for (const t in e) s.append(t, e[t]);
        return s;
      }
    },
    16554: (t, e, n) => {
