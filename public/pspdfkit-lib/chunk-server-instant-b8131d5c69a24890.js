  ...
  [2333],
  {
    46350: (e, t, s) => {
      ...
      var i = s(17375),
        ...
        c = s(44048),
        l = s(83253);
      class d extends o.WV({
        clientId: "",
        userId: null,
        presenceContent: {},
      }) {}
      class h extends o.WV({
        status: "offline",
        currentClient: null,
        clients: (0, o.D5)(),
      }) {}
      ...
      class F {
        constructor(e, t) {
          let {
            ...
            ? arguments[2]
            : {};
          (this.eventEmitter = new m.Z(
            ["connect", "disconnect", "error"].concat(n),
          )),
            (this.serverURL = e),
            (this.authPayload = t),
            (this.socket = null),
      ...
      class P {
        ...
        updateRecord(e, t, s, i) {
          return new Promise((n, o) => {
            if (!this.isKnownRecordId(e))
              return o(new a.p2(`Record with ID: ${e} not found.`));
            const r = new R({
              id: e,
              content: t,
              group: s,
        ...
        deleteRecord(e) {
          return new Promise((t, s) => {
            if (!this.isKnownRecordId(e))
              return s(new a.p2(`Record with ID: ${e} not found.`));
      ...
      class X {
        ...
        _onRecordsUpdates(e, t, s, i) {
          ...
          l.length > 0 &&
              ...
              _ &&
                ...
                (y = y.filter((e) => {
                  ...
                  const t =
                    ...
                    _.formFields.get(e.formFieldName);
            ...
            n.size > 0 &&
              ((0, a.kG)(this._bookmarkCallbacks),
              this._bookmarkCallbacks.createBookmarks(n, i));
          ...
          x.size > 0 &&
            ...
            v.size > 0 &&
              ((0, a.kG)(this._bookmarkCallbacks),
              this._bookmarkCallbacks.updateBookmarks(v)),
            w.length > 0 &&
              ((0, a.kG)(this._formFieldCallbacks),
