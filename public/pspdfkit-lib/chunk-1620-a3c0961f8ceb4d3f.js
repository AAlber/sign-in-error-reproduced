    ...
    46309: (e, t, i) => {
      ...
      class u {
          ...
          return {
            promise: new Promise(async (s, a) => {
              ...
              try {
                ...
                const { promise: f, cancel: p } = this.renderAPStream(
                  e,
                  l,
                  t,
                  i,
        ...
        renderAPStream(e, t, i, n, r, s, a) {
          if (s.length > 1) {
            const a = s.map((s) =>
              this.renderAnnotation(e, t, i, n, r, "normal" !== s ? s : void 0),
            );
            return {
              promise: a,
              cancel: () => {
              ...
              .map(
                (e) => (
                  ...
                  new a.Z({
                    ...
                    rectsOnPage: (0, n.aV)(e.rectsOnPage).map((e) =>
                      (0, s.k)(e),
                    ),
                    isAnnotation: !!e.isAnnotation,
                    annotationRect: e.annotationRect
                      ? (0, s.k)(e.annotationRect)
                      : null,
                  })
                ),
              )
