...
(self.webpackChunkPSPDFKit = self.webpackChunkPSPDFKit || []).push([
  [9859],
  {
    49859: (t, e, r) => {
      ...
      function _(t) {
        let e;
        (0, o.kG)(y, "GdPicture WebAssembly is not loaded.");
        for (
        ...
        const i = JSON.stringify(l({ type: t }, e)),
          a = JSON.parse(y.CommandHandler(i));
        if (!a.success)
          throw new Error(
            a.errorReason + ": " + a.errorMessage + "\n" + a.error,
          );
        return a;
      }
      class g {
        _mountCustomFonts(t, e) {
          (0, o.kG)(b, "WebAssembly module not loaded."), b.FS.mkdir(e);
          {
            const r = m ? b.FS.filesystems.WORKERFS : b.FS.filesystems.MEMFS;
            b.FS.mount(r, { blobs: t }, e);
          }
        }
        async loadModule(t, e, r, n, o, i, a) {
          const { Assemblies: l, Module: c } = await (async function (t, e) {
            if ("string" == typeof t) {
              const r = "pspdfkit-lib/",
                n = `${r}gdpicture-4a527d72/jit`,
                o = `${r}gdpicture-4a527d72/aot`;
              let s, i;
              e
                ? ((s = `${t}${o}/initDotnet.js`), (i = `${t}${o}`))
                : ((s = `${t}${n}/initDotnet.js`), (i = `${t}${n}`));
              const { initDotnet: a } = await import(s);
              return a(i);
            }
            throw new Error("GdPicture WASM loader not implemented");
          })(t, e);
          (y = l.GdPictureWasm.API),
            (b = c),
            _(
              "gdpicture/setLicense",
              { origin: r },
              { licenseKey: n || "DEMO_PSPDFKIT_WEB" },
            );
          const u = o ? "/fonts" : "";
          if (
            (o &&
              !b.FS.analyzePath(u).exists &&
              (this._mountCustomFonts(o, u),
              _("gdpicture/setFonts", { fontPaths: [u] })),
            i)
          ) {
            const t = await (0, s.S)(i);
          ...
          a && _("gdpicture/setFontSubstitutions", { fontSubstitutions: a });
        }
        toPdf(t, e) {
          b.FS.writeFile(c, new Uint8Array(t));
          const r = { file: u, format: "pdf" };
          e && e in i && (r.conformance = e);
          try {
            return (
              _("gdpicture/process", { input: { file: c }, output: r }),
              b.FS.readFile(u).buffer
            );
          } finally {
            try {
              b.FS.unlink(u);
        ...
        async populateDocumentTemplate(t, e) {
          let r;
          b.FS.writeFile(d, new Uint8Array(t));
          try {
      ...
      const w = class {
        constructor(t) {
          ...
          (0, n.Z)(this, "requests", new Map()),
            ...
            (0, n.Z)(this, "handleMessage", (t) => {
              ...
              if ((this.requests.delete(e.id), e.error)) {
            ...
            (this.moduleLoadPromise = this.sendRequest("loadModule", [
              d ? { baseUrl: e, wasmLoaderPath: d } : e,
              r,
              s,
              i,
              a,
        ...
        toPdf(t, e) {
          ...
          return (
            ...
            this.sendRequest("toPdf", [t, r])
          );
        }
        async populateDocumentTemplate(t, e) {
          return this.sendRequest("populateDocumentTemplate", [t, e]);
        }
        destroy() {
          var t;
          null === (t = this.workerSpawner) || void 0 === t || t.terminate(),
            (this.workerSpawner = null);
        }
        async sendRequest(t, e) {
          (0, o.kG)(this.workerSpawner, "GdPictureClient has been destroyed"),
            this.moduleLoadPromise && (await this.moduleLoadPromise);
          const r = this.workerSpawner;
          return new Promise((n, o) => {
            const s = this.assignId(),
              i = [...e].filter((t) => t instanceof ArrayBuffer);
            r.postMessage({ id: s, action: t, args: e }, i),
      ...
      const h = class {
        constructor(t) {
          ...
          (this.gdPicture = new g()),
            (this.moduleLoadPromise = this.gdPicture.loadModule(
              e,
              r,
              n,
              o,
        ...
        async populateDocumentTemplate(t, e) {
          return (
            this.moduleLoadPromise && (await this.moduleLoadPromise),
            this.gdPicture.populateDocumentTemplate(t, e)
          );
        }
        destroy() {}
      };
      ...
      const F = async function () {
        ...
        return {
          setMessageHandler(e) {
            (0, o.kG)(t, "Worker is null"), (t.onmessage = e);
          },
          postMessage(e, r) {
            var n;
            null === (n = t) || void 0 === n || n.postMessage(e, r);
          },
          terminate() {
            var e;
            null === (e = t) || void 0 === e || e.terminate(), (t = null);
          },
        };
      };
    },
