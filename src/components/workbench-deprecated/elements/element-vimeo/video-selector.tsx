...
export default function VideoSelector({ elementId, setImageSet }) {
  ...
  return (
    <div className="milkblur-light absolute left-5 top-5 z-50 w-[550px] overflow-hidden rounded-lg border border-border bg-background/80">
      <div className="sticky top-0 z-10">
        ...
        <form
          onSubmit={async (e) => {
            ...
            updateElementMetadata(elementId, { videoUrl: link });
          }}
