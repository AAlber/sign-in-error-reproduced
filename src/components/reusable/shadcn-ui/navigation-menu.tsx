...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDown
      className="relative ml-1  h-4 w-4 text-contrast transition duration-200 group-data-[state=open]:rotate-180"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
));
    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ref={ref}
          className={classNames(
            "hover:text-accent-foreground focus:text-accent-foreground block select-none rounded-sm px-2 py-2 leading-none no-underline outline-none transition-colors hover:bg-accent focus:bg-accent",
            className,
          )}
          {...props}
        >
